...
Official publication has one owner. Its review bundles are derivatives of attested Code_Aster artifacts, with portable relative evidence references; its strict publication validation remains separate from backward-compatible loading of external legacy scene bundles.
