...
Run inside Blender: File → Run Script, or:
    blender --python viz_gallery_blender.py
"""
...
# ---- Pipe Data ----
coords = [[0.0, 0.0, 0.0], [3.0, 0.0, 0.0], [3.3, 0.29999999999999993, 0.0], [3.3000000000000003, 2.3, 0.0], [3.3000000000000003, 2.5999999999999996, 0.29999999999999993], [3.3000000000000003, 2.6, 2.3]]
edges = [[0, 1], [1, 2], [2, 3], [3, 4], [4, 5]]
vmis = [322893000.0, 326694000.0, 33117800.0, 40939200.0, 162517600.0, 9736480.0]
pipe_radius = 0.05715
