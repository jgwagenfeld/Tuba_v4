...
PROJECT = load_project(Path(__file__).resolve().parents[1] / "examples" / "native-friction-review")
LOAD_PATH = PROJECT.load_study().LOAD_PATH


def build_friction_comparison_model():
    return PROJECT.run_model()["model"]
