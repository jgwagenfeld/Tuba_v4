...
_TEE = load_project(Path(__file__).resolve().parents[1] / "examples" / "pipe-tee-volume-review")
TEE_VOLUME_ELEMENT_IDS = _TEE.load_study().VOLUME_EXPORT["element_ids"]


def build_tee_volume_model():
