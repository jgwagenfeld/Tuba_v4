...
class TestTeeSif(unittest.TestCase):
    ...
    def test_tee_junction_detection_and_sifs(self):
        ...
        # By default, N1 should act as an unreinforced_tee
        # Let's compute SIF for header elements at node N1
        # Element 0: pipe_str_0 (N0 -> N1)
        i_i, i_o, k, h = compute_sifs(self.model.elements[0], self.model, node_id="N1")
